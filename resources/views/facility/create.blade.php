<form id="form-save-facility" class="row g-3" method="POST" action="{{ route('facility.store') }}">
    ...
    <div class="col-md-12">
        ...
        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
            name="name" value="{{ old('name') }}" placeholder="e.g. Free High-Speed Wi-Fi">
        @error('name')
    ...
    <div class="col-md-12">
        ...
        <input type="text" class="form-control @error('icon') is-invalid @enderror" id="icon"
            name="icon" value="{{ old('icon', 'fas fa-check') }}" placeholder="e.g. fas fa-wifi">
    ...
    <div class="col-md-12">
        ...
        <textarea class="form-control" id="detail" name="detail" rows="3" placeholder="Description of the facility...">{{ old('detail') }}</textarea>
        @error('detail')
            <div class="text-danger mt-1">
                {{ $message }}
            </div>
